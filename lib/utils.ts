...
export const authFormSchema = (type: string) => z.object({
  ...
  postalCode: type === 'login' ? z.string().optional() : z.string().min(4).max(6),
  dateOfBirth: type === 'login' ? z.string().optional() : z.string().min(10).max(10),
  ssn: type === 'login' ? z.string().optional() : z.string().min(3).max(4),
